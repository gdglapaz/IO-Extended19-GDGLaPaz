...
INSERT INTO Session (id_session,title,description,date,time,type, extraInfo, extraPathImage, extraTitle, hasDetails) VALUES (16, 'Lets Talk About Flutter State Management', 'En esta charla hablaré sobre algunas arquitecturas en Flutter, para luego mostrar una aplicación de ejemplo y cómo puede ser más complicado si no usamos un patrón apropiado. Finalmente, implementaré una arquitectura basada en el paquete Provider y, como si hiciera cambios mínimos en el código, podemos reducir la complejidad.','09/11/2019', '15:30', 'T',1, 'assets/img/speakers/DiegoV.jpg', 'Diego Velasquez & Argel Bejarano Flutter State Management', 1);
